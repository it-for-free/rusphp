...
/**
 * Сущность для замены без слияния в массиве.
 * 
 * Код вязт из Yii2, 
 * в нашей библиотеке нужен в частности для работы  для работы ItForFree\rusphp\PHP\ArrayLib\Merger::mergeRecursivelyWithReplace()
